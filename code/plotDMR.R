...
example.region<-plot.gene(region_tumor_mC, region_tumor_coverage, region_normal_mC, region_normal_coverage,  "example.DMR.ps", tumor_samples, normal_samples , 0.5, main="exmaple DMR")
